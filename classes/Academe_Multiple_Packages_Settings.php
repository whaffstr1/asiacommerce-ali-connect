...
class Academe_Multiple_Packages_Settings extends WC_Shipping_Method
{
    ...
    function get_settings($current_section = '')
    {
        ...
        $settings = apply_filters('woocommerce_multi_packages_settings', array(
            'enabled' => array(
                'type'      => 'hidden',
                //'title'     => __('Enable Package Grouping feature', 'academe-package-config-woo'),
                'title'     => __('Enable Package Grouping feature Activated', 'academe-package-config-woo'),
                'default'   => 'yes',
                'desc'      => __('Enable Multiple Shipping Packages', 'academe-package-config-woo'),
                //'custom_attributes' => array( 'style' => 'display' ),
            ),
            ...
            //     'default'   => __('supplier_name', 'academe-package-config-woo'),
